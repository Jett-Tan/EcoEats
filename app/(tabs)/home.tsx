    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <PressableIcon
          ...
          size={24}
          onPress={() => navigation.navigate('Profile', { initialTab: 'bookmark', bookmarkedItems })}
        />
      </View>
      <View style={styles.tabContainer}>
        <TouchableOpacity
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        {chosenItems.map((item) => (
          <View key={item.id} style={styles.itemContainer}>
            ...
            <View style={styles.itemTextContainer}>
              <Text style={styles.itemStore}>{item.store}</Text>
              <Text style={styles.itemLocation}>{item.location.Road}, {item.location.Block}, {item.location.UnitNumber}, {item.location.PostalCode}</Text>
              <Text style={styles.itemRating}>{item.rating} ⭐️</Text>
            </View>
          </View>
        ))}
